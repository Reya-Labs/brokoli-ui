...
describe('<NotificationContent />', () => {
  ...
  it('renders correctly with default props', () => {
    ...
    expect(screen.getByTestId('CloseButton-CloseButtonStyled-error950')).toBeInTheDocument();
  ...
  it('calls onCloseNotification and closeToast callbacks when close button is clicked', () => {
    ...
    const closeButton = screen.getByTestId('CloseButton-CloseButtonStyled-error950');
